          ...
          <div className="slider-item">
            ...
            <div className="customeborder bg-green-600 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/website-development.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
      ...
      <div className="slider-item">
            ...
            <div className="customeborder Pr8Nkbn hover:opacity-90 ">
              <a href="">
                ...
                <img  src="../../../public/img/logo-design.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          ...
          <div className="slider-item">
            ...
            <div className="customeborder tLUiXHr  hover:opacity-90 ">
              <a href="">
                ...
                <img  src="../../../public/img/seo.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          ...
          <div className="slider-item">
            ...
            <div className="customeborder bg-pink-900 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/architecture-design.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          ...
          <div className="slider-item">
            ...
            <div className="customeborder colorimg5 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/social-media-marketing.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          ...
          <div className="slider-item">
            ...
            <div className="customeborder colorimg6 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/voice-over.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          {/* 7 */}
          <div className="slider-item">
            ...
            <div className="customeborder colorimg7 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/software-development.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          {/* 8 */}
          <div className="slider-item">
            ...
            <div className="customeborder bg-red-700 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/data-science.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
         {/* 9 */}
         <div className="slider-item">
            ...
            <div className="customeborder colorimg9 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/product-photography.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          {/* 10 */}
          <div className="slider-item">
            ...
            <div className="customeborder bg-green-500 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/e-commerce.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
          {/* 11 */}
          <div className="slider-item">
            ...
            <div className="customeborder bg-pink-700 hover:opacity-90 ">
              <a href="">
                ...
                <img  src="/img/video-editing.png" alt="" className="w-full h-auto rounded-lg" />
              </a>
            </div>
          </div>
